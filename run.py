...
parser.add_argument('--epoch', default=200, type=int, help='|训练轮数，继续训练时为增加的训练轮数|')
...
parser.add_argument('--lr_adjust_num', default=150, type=int, help='|从初始学习率到最终学习率经过的调整次数，余玄下降法|')
